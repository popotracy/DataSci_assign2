...
%save([pwd,'/',Subject_ID,'_Baseline.mat'],"Baseline");

% Baseline is caculated and saved in the workspace.
% Add detrend to remove baseline drift
%% MVC measurement

MVC_duration = 3;                                                           % 3 seconds as default
Rest_duration = 5;                                                         %  1min as default.
Ready_duration = 5;
MVC_measurement_n=1;                                                        % Number of trials for measuring MVC.
...
while MVC_measurement_n>0;
    ...
    if DAQMode, start(d,"continuous");
        ...
        while GetSecs < startTime + MVC_duration
            ...
            torque_mvc_data.cDAQ1Mod1_ai23 =-(torque_mvc_data.cDAQ1Mod1_ai23-Baseline);
    ...
    torque_mvc_dt=(torque_mvc.Variables)
    % add detrend...
