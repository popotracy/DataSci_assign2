...
Baseline=mean(torque_cal_dt);                                   % Baseline is caculated and saved in the workspace. 
...
%torque_mvc_data.cDAQ1Mod1_ai23=torque_mvc_data.cDAQ1Mod1_ai23;
    ...
    % add detrend...
    MVCC(i)=max(movmean(torque_mvc_dt,d.Rate*0.5));                  % A 0.5s moving average window was used to calculate for MVC technique. 
    i=i+1;
